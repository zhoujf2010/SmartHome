...
class LovelacePanel extends LitElement {
  ...
  protected render(): TemplateResult | void {
    ...
    console.log("narrow=" + JSON.stringify(this.narrow));
    console.log("lovelace=" + JSON.stringify(this.lovelace));
  ...
  public get urlPath() {
    return null;//this.panel!.url_path === "lovelace" ? null : this.panel!.url_path;
  }
  ...
  private async _fetchConfig(forceDiskRefresh: boolean) {
    ...
    let confMode: Lovelace["mode"] = "storage";//this.panel!.config.mode;
  ...
  private _setLovelaceConfig(
    ...
    this.lovelace = {
      ...
      setEditMode: (editMode: boolean) => {
        ...
        showSaveDialog(this, {
          lovelace: this.lovelace!,
          mode: "storage",//this.panel!.config.mode,
          narrow: this.narrow!,
        });
      },
