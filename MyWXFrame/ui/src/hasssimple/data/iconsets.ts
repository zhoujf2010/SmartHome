...
import { IconMetaFile } from "../common/types.js";

export const iconMetadata = (iconMetadata_ as any).default as IconMetaFile;

import { IconMeta } from "../common/types";
