...
import { HassEventBase,HassServiceTarget } from "../../core/type";
import { Connection } from "../../core/Connection";
import {getCollection}  from "../../core/collection";
...
export const subscribeLovelaceUpdates = (
  ...
  conn.subscribeEvents<LovelaceUpdatedEvent>((ev:any) => {
...
export const getLovelaceCollection = (
  ...
  getCollection(
    conn,
    `_lovelace_${urlPath ?? ""}`,
    (conn2:any) => fetchConfig(conn2, urlPath, false),
    (_conn:any, store:any) =>
...
export const getLegacyLovelaceCollection = (conn: Connection) =>
  getCollection(
    conn,
    "_lovelace",
    (conn2:any) => fetchLegacyConfig(conn2, false),
    (_conn:any, store:any) =>
