...
export class HaStateLabelBadge extends LitElement {
  ...
  private _computeLabel(domain:any, entityState:any, _timerTimeRemaining:any) {
    if (
  ...
  private startInterval(stateObj:any) {
    this.clearInterval();
  ...
  private calculateTimerRemaining(stateObj:any) {
