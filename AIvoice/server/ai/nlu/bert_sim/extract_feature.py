from nlu.bert_sim import modeling
from nlu.bert_sim import tokenization
from nlu.bert_sim.graph import optimize_graph
from nlu.bert_sim import args
...
if __name__ == "__main__":
    ...
    import numpy as np
    while True:
        question = input('questionA: ')
        A = bert.encode([question])
        question = input('questionB: ')
        B = bert.encode([question])
