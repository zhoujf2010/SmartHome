...
from nlu.training_data.util import lazyproperty, write_to_file, list_to_str, check_duplicate_synonym
...
class TrainingData(object):
    ...
    def as_json(self, **kwargs):
        ...
        from nlu.training_data.formats import RasaWriter
        return RasaWriter().dumps(self)

    def as_markdown(self):
        # type: () -> str
        """Generates the markdown representation of the TrainingData."""
        from nlu.training_data.formats.markdown import MarkdownWriter
